...
namespace AnuQRandom
{
    ...
    public abstract class AnuClient
    {
        ...
        protected string GetRequestUrl(AnuRequestEntity requestEntity)
        {
        ...
        public virtual async Task<RequestedData> RequestAsync(AnuRequestEntity? requestEntity = null)
        {
    ...
    /// </summary>
    public class OldAnuClient : AnuClient
    {
    ...
    /// </summary>
    public class NewAnuClient : AnuClient
    {
        ...
        public override async Task<RequestedData> RequestAsync(AnuRequestEntity? requestEntity = null)
        {
        ...
        public NewAnuClient(string apiKey)
        {
            ApiKey = apiKey;
        }
    }
